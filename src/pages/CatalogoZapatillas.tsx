...
const zapatillaProducts = [
  {
    name: "AMIRI MA-1",
    description: "Zapatillas de lujo con diseño exclusivo y materiales premium",
  ...
  {
    name: "Air Force 1",
    description: "Clásicas Nike Air Force 1, icónicas y versátiles",
    image: "https://images.unsplash.com/photo-1551698618-1d585e1c61ef?w=400&q=80",
    price: "$69.990",
    stock: false
  }
];

const CatalogoZapatillas = () => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-secondary/30 py-8">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4">Zapatillas</h1>
          <p className="text-muted-foreground text-lg max-w-2xl">
            Las últimas tendencias en sneakers y calzado urbano. Encuentra tu estilo perfecto.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {zapatillaProducts.map((product, index) => (
...
export default CatalogoZapatillas;
